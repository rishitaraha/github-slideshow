...
BEGIN
  ...
  mvtgeom AS (
    ...
    -- HACK: Hardcoding gradient and width attributes.
    -- FIXME: Handle attributes in a better way.
    SELECT ST_AsMVTGeom(ST_Transform(ST_Force2D(feature_table.geometry), 3857), bounds.b2d) AS geom, feature_table.id, feature_table.type, feature_table.properties->>'text' as textbox_text, feature_table.attributes->>'gradient' as gradient, feature_table.attributes->>'chainwidth' as chain_width
