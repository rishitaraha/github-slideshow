...
from ..helpers import calculate_site_production_for_financial_year


class GetProductionKpiSerializer(serializers.Serializer):
    ...
    def to_representation(self, instance):
        ...
        # Calculating monthly production.
        monthly_production = calculate_site_production_for_financial_year(
            site_id, financial_year_ending
        )
        response["monthly_production"] = monthly_production
        response[
            "financial_year"
