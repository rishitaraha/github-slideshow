...
from dashboard.helpers.planning_kpi_calculator import (
    calculate_total_area_for_layer_categories,
)
...
class GetPlanningKpiSerializer(serializers.Serializer):
    ...
    def to_representation(self, instance):
        ...
        response["total_area"] = calculate_total_area_for_layer_categories(
            site_id, financial_year_ending, month
        )
        response[
            "financial_year"
