...
from ..helpers import get_safety_index_for_financial_year


class GetSafetyIndexKpiSerializer(serializers.Serializer):
    ...
    def to_representation(self, instance):
        ...
        # Calculating monthly safety index.
        monthly_safety_index = get_safety_index_for_financial_year(
            site_id, financial_year_ending
        )

        response["monthly_safety_index"] = monthly_safety_index
        response[
            "financial_year"
