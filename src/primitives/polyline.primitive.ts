 ...
 * _depthTest: Disable the depth test to camera or not. It means cesium entity or primitives will have show order from the camera.
 *
...
export class PolylinePrimitive {
  ...
  constructor(options: PolylinePrimitiveOptions) {
    ...
    this._clamped = defaultValue(options.clampToGround, true);
