...
export declare type MVTImageryProviderOptions = {
  ...
  requestTransformFn?: (url: string) => any;
...
export declare type PropertyValueSpecification<T> =
  | T
  | CameraFunctionSpecification<T>
  | ExpressionSpecificationArray;
export declare type DataDrivenPropertyValueSpecification<T> =
  | T
  | CameraFunctionSpecification<T>
...
export declare type LayerSpecification =
...
export declare type RequestTransformFunction = (
  url: string,
