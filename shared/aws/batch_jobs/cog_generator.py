...
from .schemas import CogGeneratorPayloadSchema


def submit_cog_generator_job(job_name: str, payload: CogGeneratorPayloadSchema):
    ...
    job_output = AwsManager.submit_batch_job(
        EnvVariable.AWS_BATCH_COG_JOB_DEFINITION.value,
        EnvVariable.AWS_BATCH_COG_JOB_QUEUE.value,
        job_name,
        batch_job_env_variables,
    )
