...
from .schemas import VectorTilesGeneratorPayloadSchema


def submit_vector_tile_generator_job(
    job_name: str, payload: VectorTilesGeneratorPayloadSchema
) -> BatchJob:
    ...
    job_output = AwsManager.submit_batch_job(
        EnvVariable.AWS_BATCH_VECTOR_TILES_JOB_DEFINITION.value,
        EnvVariable.AWS_BATCH_VECTOR_TILES_JOB_QUEUE.value,
        job_name,
        batch_job_env_variables,
    )
