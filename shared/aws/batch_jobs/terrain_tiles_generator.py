...
from .schemas import TerrainTileGeneratorPayloadSchema


def submit_terrain_tile_generator_job(
    job_name: str, payload: TerrainTileGeneratorPayloadSchema
):
    ...
    job_output = AwsManager.submit_batch_job(
        EnvVariable.AWS_BATCH_TT_JOB_DEFINITION.value,
        EnvVariable.AWS_BATCH_TT_JOB_QUEUE.value,
        job_name,
        batch_job_env_variables,
    )
