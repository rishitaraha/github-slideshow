...
from layer_manager.models import AccessTag, Layer, LayerFile
...
class TestCannotDownloadLayer(BaseTestCase):
    @classmethod
    def setUpTestData(cls):
        ...
        cls.layer2 = Layer.objects.create(
            name="Test Layer",
            iteration=cls.iteration2,
            site=cls.site2,
            type=LayerType.MBTILES.value,
        )
        cls.layerfile2 = LayerFile.objects.create(
            layer=cls.layer2,
            file_info=cls.file_info2,
        )
